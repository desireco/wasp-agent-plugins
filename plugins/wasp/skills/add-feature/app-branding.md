...
2. Update the Wasp Spec file `app` block according to the Wasp docs
3. Add name, description, og, and other critical meta tags to the `app.head` section of the Wasp Spec file.
